...
('Falla en Climatización A-202', 'El aire acondicionado no enciende y hace un ruido metálico.', 'Abierto', 'Alta', 1, NULL, 'HVAC'),
('Gotera en Laboratorio 3', 'Filtración de agua detectada cerca del rack de servidores.', 'Asignado', 'Alta', 1, 3,'plomeria'),
('Mantenimiento Preventivo Elevador', 'Revisión mensual de cables y sensores del elevador norte.', 'En Progreso', 'Media', 2, 3, 'General'),
('Lámpara fundida Pasillo B', 'Cambiar luminaria LED en el segundo piso.', 'Resuelto', 'Baja', 1, 3, 'Electrico'),
('Puerta de Acceso Atascada', 'La cerradura electrónica no reconoce los tags.', 'Bloqueado', 'Alta', 2, NULL, 'Carpinteria');
('Actualización de Switch', 'Configuración de VLAN en el rack principal.', 'Abierto', 'Media', 1, NULL, 'IT');
